...
const Card = (props) => {
  return (
    <div className="w-64 h-80 bg-login-img rounded-2xl text-center p-10 m-5">
      <div className="images">
        <a href={props.cardClick}>
          <img
            src={props.avatars}
            alt="avatar"
            className="rounded-full bg-white p-1 mx-0 md:mx-5"
          />
        </a>
      </div>
      <div className="card-names mt-10">
        <p className="font-bold text-white text-2xl"> {props.cardName} </p>
      </div>
      <div className="like-section flex justify-center mt-2">
        <div className="likes ml-3">
          {props.likeCheck === true ? (
            <svg
              version="1.0"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512.000000 512.000000"
              preserveAspectRatio="xMidYMid meet"
              className="w-9 fill-blue-400 relative"
            >
              <g
              ...
              >
                <path
                  d="M3088 5099 c-69 -36 -78 -70 -78 -284 0 -166 2 -190 20 -225 23 -45
    80 -80 130 -80 50 0 107 35 130 80 18 35 20 59 20 225 0 166 -2 190 -20 225
    -37 73 -127 99 -202 59z"
                />
                <path
                  d="M2126 4691 c-45 -30 -66 -70 -66 -127 0 -65 20 -93 167 -236 79 -76
    121 -110 149 -118 117 -35 226 84 179 195 -16 40 -192 227 -259 276 -48 36
    -124 40 -170 10z"
                />
                <path
                  d="M4024 4681 c-21 -15 -87 -78 -146 -138 -76 -79 -110 -121 -118 -149
    -35 -117 84 -226 195 -179 40 16 227 192 276 259 52 71 35 169 -37 217 -46 30
    -122 26 -170 -10z"
                />
                <path
                  d="M2805 4196 c-41 -18 -82 -68 -94 -114 -5 -20 -33 -127 -60 -236 -94
    ...
    1200 390 0 c372 0 393 -1 430 -20z"
                />
                <path
                  d="M988 879 c-43 -22 -78 -81 -78 -129 0 -76 74 -150 150 -150 76 0 150
    74 150 150 0 50 -35 107 -80 130 -49 25 -94 25 -142 -1z"
            ...
            <svg
              ...
              viewBox="0 0 512.000000 512.000000"
              preserveAspectRatio="xMidYMid meet"
              className="w-9 fill-white relative"
            >
              <g
                transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                stroke="none"
    ...
    74 150 150 0 50 -35 107 -80 130 -49 25 -94 25 -142 -1z"
          ...
          <input
            type="checkbox"
            id={props.idPerson}
            checked={props.likeCheck}
            onChange={props.handleLikeChange}
            className="relative bottom-5 opacity-0"
          />
        </div>

        <div className="dislike mx-3 mt-3">
          {props.dislikeCheck === true ? (
            <svg
              version="1.0"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512.000000 512.000000"
              preserveAspectRatio="xMidYMid meet"
              className="w-9 fill-red-400"
            >
              <g
                transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                stroke="none"
              >
                <path
                  d="M95 5106 c-41 -18 -83 -69 -90 -109 -3 -18 -4 -580 -3 -1249 3 -1211
              ...
              675 1 717 -20z"
                />
                <path
                  d="M917 3326 c-70 -25 -97 -66 -97 -146 0 -45 4 -55 38 -92 33 -35 45
              -41 92 -46 96 -9 160 49 160 144 0 106 -95 175 -193 140z"
                />
                <path
                  d="M2435 921 c-16 -10 -85 -74 -151 -142 -138 -140 -151 -167 -118 -247
              27 -69 105 -106 181 -87 40 10 289 258 304 303 22 66 -10 146 -71 177 -40 21
              -109 19 -145 -4z"
                />
                <path
                  d="M3558 915 c-24 -16 -42 -40 -54 -70 -29 -77 -13 -109 130 -253 66
              -68 133 -130 148 -138 83 -44 197 10 214 101 13 69 -2 93 -135 228 -69 71
              -138 135 -153 143 -43 22 -108 18 -150 -11z"
                />
                <path
                  d="M3002 571 c-66 -42 -72 -64 -72 -277 0 -182 1 -193 23 -225 61 -91
    ...
    21z"
          ...
          <input
            type="checkbox"
            id={props.idPerson}
            checked={props.dislikeCheck}
            onChange={props.handleDislikeChange}
            className="relative bottom-8 opacity-0"
          />
        </div>
      </div>
    </div>
